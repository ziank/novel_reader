...
class Biquge11Parser : BaseParser() {
    override val name: String
        get() = "笔趣阁"

    override fun getSearchBookUrl(bookName: String): String {
        val bookName = URLEncoder.encode(bookName, "GBK")
        return String.format("https://www.biquge11.com/modules/article/search.php?searchtype=articlename&searchkey=%s", bookName)
    }
